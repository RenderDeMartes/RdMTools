...
def JointsBtn(*args):  
    ...
    cmds.joint(e= True, zso=True, oj= "xzy", sao = "xdown")
    cmds.delete ('joint1')
    cmds.select ("R_arm_2")    
    cmds.joint(e= True, zso=True, oj= "xzy", sao = "xup")
...
############################
    ...
    cmds.setAttr("R_UpTwist_IK.dWorldUpAxis", 0)
    cmds.setAttr("R_DownTwist_IK.dWorldUpAxis",0)
    ...
    #Bind Set
    cmds.select ('L_UpArmTwist01', 'L_UpArmTwist02', 'L_DownArmTwist01', 'L_DownArmTwist02',  'L_arm_1', 'R_UpArmTwist01', 'R_UpArmTwist02', 'R_DownArmTwist01', 'R_DownArmTwist02',  'R_arm_1')
